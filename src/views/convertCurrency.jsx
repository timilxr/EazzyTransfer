                        ...
                        <div className="verify_body text-center mt-5 position-relative">
                            {view == 'Convert Currency' ?
                                ...
                                <>
                                    ...
                                    <div className="w-100 text-center mt-5">
                                        <button onClick={() => setView('Convert Currency')} className="btn mb-2 btn-lg px-md-5" style={{ background: '#0898A0', borderRadius: '2px', color: 'white', fontSize: '14px' }}>Authorize</button>
                                    </div>
                                </>
                            }
                        </div>
