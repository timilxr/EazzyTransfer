               ...
               <div className="row">
                   <div className="col-md-7 sub_col_two">
                       ...
                       <div className="mb-3 mt-5">
                        ...
                        <h6 className="col_two_subscript">Didnt get an sms, <Link>resend in 0.12s</Link></h6>
                        <button type="button" class="btn btn-primary btn-lg btn-block proceed_two_btn">Done</button>
                   </div>
               </div>
            </React.Fragment>
    )
