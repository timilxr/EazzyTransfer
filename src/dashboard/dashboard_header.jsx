    ...
    return (
        <React.Fragment>
            <header className="menu_header p-3 shadow-sm" id="myHeader">
                <nav className="navbar navbar-expand-lg navbar-light bg-light nav-header p-0">
                    ...
                    <div className="collapse navbar-collapse header_nav" id="navbarNavDropdown">
                        ...
                        <div className="row p-3 pl-4">
                            <div className="col-12 col-lg p-0" style={{ display: "flex", alignItems: 'center', paddingLeft: "0px" }}>
                            ...
                            <div className="col-12 col-lg-6" style={{ display: "flex", borderLeft: "1px solid #DFE0EB", paddingLeft: "0px" }}>
                                <h6 className="user_name ml-md-3">FirstName LastName</h6>
                                <Link to="/dashboard//dashboard/accounts" className="text-decoration-none">
