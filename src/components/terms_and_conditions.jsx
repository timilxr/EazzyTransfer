            ...
            <React.Fragment>
               <div className="row documentation_row">
                   ...
                   <div className="col-md-12">
                    ...
                    We(Myyinvest.com.ng) are concerned about your access to and use of the https://www.myyinvest.com.ng website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). 
                    ...
                    Accordingly, those persons who choose to access the Site from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.The Site is intended for users who are at least 18 years old.
                    Persons under the age of 18 are not permitted to use or register for the Site.
                    </p>
                   </div>
                </div>
                <div className="row documentation_row">
                    <div className="col-md-6 documentation_col">
                        <div className="documentation_content">
                            ...
                            There are several laws governing intellectual property protection in Nigeria. 
                            These laws which applies include: Nigerian Copyright Act Cap 28 Laws of the Federation of Nigeria 2004, Patents and Designs Act Cap P2 Laws of the Federation of Nigeria 2004 and Trade Marks Act, Cap T13 Laws of the Federation of Nigeria 2004. 
                        ...
                        <div className="documentation_content">
                            ...
                            you have the legal capacity and you agree to comply with these Terms of Use ;you are not a minor in the jurisdiction in which you reside; you will not access the Site through automated or non-human means, whether through a bot, script, or otherwise; 
                            you will not use the Site for any illegal or unauthorized purpose; and your use of the Site will not violate any applicable law or regulation.If you provide any information that is untrue, inaccurate, not current, or incomplete, 
                            we have the right to suspend or terminate your account and refuse any and all current or future use of the Site (or any portion thereof).
                        </p>
                        </div>
                        <div className="documentation_content">
                            <b>PAYMENT GUIDELINES</b>
                            <p>
                            All Investments made on this platform are directed towards the trustees. 
                            The trustees serve as the middle man between investors and the myyinvest. 
                            Your investment is not kept in the myyinvest account. 
                            The investment is kept in the Trust account which is highly regulated. 
                        </p>
                        </div>
                        <div className="documentation_content">
                            <b>MOBILE APPLICATION LICENSE</b>
                            <p>
                            Use License If you access the Site via a mobile application, then we grant you a revocable, non-exclusive, non-transferable, limited right to install and use the mobile application on wireless electronic devices owned or controlled by you, 
                            and to access and use the mobile application on such devices strictly in accordance with the terms and conditions of this mobile application license contained in these Terms of Use. You shall not: Decompile, reverse engineer, disassemble, 
                            attempt to derive the source code of, or decrypt the application; Make any modification, adaptation, improvement, enhancement, translation, or derivative work from the application; Violate any applicable laws, rules, or regulations in 
                            connection with your access or use of the application; Remove, alter, or obscure any proprietary notice (including any notice of copyright or trademark) posted by us or the licensors of the application; Use the application for any revenue generating endeavor, commercial enterprise, or other purpose for which it is not designed or intended; 
                            Make the application available over a network or other environment permitting access or use by multiple devices or users at the same time; Use the application for creating a product, service, or software that is, directly or indirectly, competitive with or in any way a substitute for the application; Use the application to send automated queries to any website or to send any unsolicited commercial e-mail; OR 
                        ...
                        <div className="documentation_content">
                            ...
                            We will not be liable to you or any third party for any modification, price change, suspension, or discontinuance of the Site. We cannot guarantee the Site will be available at all times. 
                        ...
                        <div className="documentation_content">
                            ...
                            <p>
                            IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SITE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING 
                            THE two (2) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.
                        </p>
                        </div>
                        <div className="documentation_content">
                            <b>MISCELLANEOUS</b>
                    ...
                    <div className="documentation_content">
                            ...
                            <p>
                            You will be required to register with the Site. You must keep your password confidential and will be responsible for all use of your account and password. 
                        ...
                        <div className="documentation_content">
                            ...
                            By posting a review, you hereby grant to us a perpetual, non-exclusive, worldwide, royalty-free, fully-paid, assignable, and sublicensable right and license to reproduce, modify, translate,transmitbyanymeans,display,perform,and/ordistributeallcontent relatingtoreviews.
                        </p>
                        </div>
                        <div className="documentation_content">
                            <b>SITE MANAGEMENT</b>
                            <p>
                           We reserve the right, but not the obligation, to: Monitor the Site for violations of these Terms of Use; Take appropriate legal action against anyone who, in our sole discretion, violates the law or these Terms of Use, including without limitation, reporting such user to law enforcement authorities; 
                           ...
                           and Otherwise manage the Site in a manner designed to protect our rights and property and to facilitate the proper functioning of the Site.
                        </p>
                        </div>
                        <div className="documentation_content">
                            <b>TERM OF TERMINATION</b>
                            <p>
                        ...
                        <div className="documentation_content">
                            <b>CORRECTIONS</b>
                            <p>
                            You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial There may be information on the Site that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Site at any time, without prior notice.
                        </p>
                        </div>
                        <div className="documentation_content">
                            <b>INDEMNIFICATION</b>
                            <p>
                            You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of our respective officers, agents, partners, and employees, from and against any loss, damage, liability, claim, or demand, including reasonable attorneys’ fees and expenses, made by any third party due to or arising out of: Your Contributions; Use of the Site; Breach of these Terms of Use; Any breach of your representations and warranties set forth in these Terms of Use; Your violation of the rights of a third party, including but not limited to intellectual property rights; or Any overt harmful act toward any other user of the Site with whom you connected via the Site. Notwithstanding the foregoing, we reserve the right, at your expense, to assume the exclusive defense and control of any matter for which you are required to indemnify us, and you agree to cooperate, at your expense, with our defense of such claims. We will use reasonable efforts to notify you of any such claim, action, or proceeding which is subject to this indemnification upon becoming aware of it.
                        </p>
                        </div>
                        <div className="documentation_content">
                            <b>USER DATA</b>
